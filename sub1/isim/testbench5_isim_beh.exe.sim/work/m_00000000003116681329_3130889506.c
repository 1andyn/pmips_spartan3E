...
#endif
static const char *ng0 = "IO[%b,%b,%b] IMEM[%d,%b] DMEM[%d,%d,%d] ALU[%d] Signals[%b,%b,%0d], ALUOUT:[%b], Stall: %b, IFID:%b, IDEX: %b, EXMEM:%b, ALUMUXOutput:%b, Register:%b, EXMEMALUOUT:%b";
...
extern void work_m_00000000003116681329_3130889506_init()
{
	static char *pe[] = {(void *)Initial_39_0,(void *)Always_40_1,(void *)Initial_43_2,(void *)Initial_58_3,(void *)Monitor_59_4};
	xsi_register_didat("work_m_00000000003116681329_3130889506", "isim/testbench5_isim_beh.exe.sim/work/m_00000000003116681329_3130889506.didat");
