...
#endif
static const char *ng0 = "IO[%b,%b,%b] IMEM[%d,%b] DMEM[%d,%d,%d] ALU[%d] Signals[%b,%b,%0d], ALUOUT:[%b], Stall: %b, IFID:%b, IDEX: %b, EXMEM:%b, IDEXMEMWRITE:%b, EXMEMWRITE:%b, EXMEMALUOUT:%b";
...
extern void work_m_00000000003641327811_3130889506_init()
{
	static char *pe[] = {(void *)Initial_41_0,(void *)Always_42_1,(void *)Initial_45_2,(void *)Initial_60_3,(void *)Monitor_61_4};
	xsi_register_didat("work_m_00000000003641327811_3130889506", "isim/testbench5_isim_beh.exe.sim/work/m_00000000003641327811_3130889506.didat");
